...
# Default player scores and Batting order
player_score = 0
bot_score = 0
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        # Display player bating or bowling status
        if player is True:
        ...
        if cv2.waitKey(10) & 0xFF == 32:
            ...
            if player is True:  # i.e. player will bat first
                ...
                if player_num == bot_num:
                    print('ME-> {} - AI-> {}'.format(player_num, bot_num))
                    print('Player is out!')
                ...
                if bot_num == player_num:
                    ...
                    # resets flags for new match
                    player = True
                    bot = False

                # Bot notout, makes runs
                else:
                    bot_score += bot_num
                    print('P-> {} - AI-> {}'.format(player_num, bot_num))
