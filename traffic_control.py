...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        ...
        self.originalImage = pygame.image.load('D:\\images\\bike.png')
        self.image = pygame.image.load('D:\\images\\bike.png')
...
class Main:
    ...
    background = pygame.image.load('D:\\images\\intersection.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal images and font
    redSignal = pygame.image.load('D:\\images\\red.png')
    yellowSignal = pygame.image.load('D:\\images\\yellow.png')
    greenSignal = pygame.image.load('D:\\images\\green.png')
